...
- The integrity check is browser-native. Judges can run the verifier page and
  recompute the proof-room hashes without cloning the repo.
...
CSPR Guardian makes Casper the payment and evidence layer for autonomous RWA
treasury agents: the agent buys specialized intelligence, makes a constrained
capital decision, and leaves a public audit trail that judges can recompute.
